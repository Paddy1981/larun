    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 py-12 px-4">
        <Card variant="elevated" padding="lg" className="max-w-md w-full text-center">
          ...
          <CardTitle as="h1" className="text-2xl mb-2">Welcome to LARUN!</CardTitle>
          <CardDescription>Your account has been created. Redirecting to dashboard...</CardDescription>
        </Card>
      </div>
    );
  }
      ...
      <div className="w-full max-w-md">
        <Card variant="elevated" padding="lg">
          <CardHeader className="text-center">
            ...
            <CardDescription>Start discovering exoplanets with AI</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2">
                <Button type="submit" fullWidth isLoading={isLoading} disabled={isOAuthLoading !== null}>
                  Create Account
                </Button>
              </div>
            </form>
